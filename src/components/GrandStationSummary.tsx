...
const GrandStationSummary = ({ totalSales, totalCash, totalPos, totalLostLiters }: GrandStationSummaryProps) => {
  const stats = [
    ...
    { label: "Unrecorded Sold Vol.", value: formatLiters(totalLostLiters), icon: ShieldAlert, color: "text-rose-600", bg: "bg-rose-50" },
  ];
  ...
  return (
    <div className="mb-8 space-y-4">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        {stats.map((stat) => (
          <div key={stat.label} className="bg-white p-5 rounded-2xl border-2 border-slate-100 flex items-center gap-4">
